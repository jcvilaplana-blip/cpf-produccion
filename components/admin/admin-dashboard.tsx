...
import {
  ...
  Crown, FolderTree, Star, TrendingUp, ArrowUpRight, CreditCard, Map,
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {([
              ...
              { label: "Ver Mapa", desc: "Tiempo real", s: "map" as AdminSection, icon: Map, color: "bg-blue-100 text-blue-700", border: "border-blue-200" },
